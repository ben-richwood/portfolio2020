...
export const PROJECTS = (function(){
  let obj = {
    "list" : [
      ...
      */
        ...
        "year": 2018,
        "description": "<p>This is a personal project to create my own map system – in place of Google Maps. The project includes design of the elements and coding.</p><p>Started in 2018 with plain javascript, I rebuilt it from the ground up with Nuxt and Vuetify.</p><h4>Motivations</h4><ul><li>Getting out of Google Maps</li><li>Geography and mapping</li><li>Mapbox and HTML Canvas</li><li>Digging further into Nuxt and Vue</li></ul>",
  ...
  deepFreeze( obj.list.sort(function (a, b) {
