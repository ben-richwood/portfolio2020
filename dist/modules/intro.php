  ...
  <div class="light">
    <div class="popup container">
      ...
      <?php /* <div class="row">
        <div class="col-12">
          <div class="tabs-nav">
            <div data-tab="0" class="subtabs active tc" id="one">Map</div>
            <div data-tab="1" class="subtabs tc" id="two">Controls</div>
            <div data-tab="2" class="subtabs tc" id="two">Analytics</div>
          </div>
          <div class="tab-container">
            <div class="tabs tab-0">
              <div>
                <p>The project page is an interactive map, where you can explore the different projects I worked on, and sort them by skills.</p>
              </div>
              <div>
                To interact with the portfolio, it's very much like Google Maps. Use the following controls:
                <p><b>Left click</b> to drag and pan the map</p>
                <p><b>Double click</b> to open a project</p>
                <p><b>Wheel</b> to zoom in/out</p>
                <?php echo file_get_contents("./assets/img/icons/mice.svg"); ?>
              </div>
              <div>
                <p class="mb">Privacy does matter to me. I hate being tracked when browsing and visiting websites.</p>
                <p class="mb">Analytics wil start as soon as you pass the intro, unlless you uncheck the checkbox.</p>
                <p>More about privacy on the option menu (Space bar)</p>
                <div style="margin-top: .8rem;">
                  <input type="checkbox" name="analyticsCheckbox" value="analyticsCheckbox" id="analyticsCheckbox" checked><label style="margin-left: 1rem;" for="analyticsCheckbox">Accept analytics</label>
                </div>
